...
.pb-bw-socials { display: flex; align-items: center; gap: 6px; }
.pb-bw-social {
    width: 22px; height: 22px;
...
.pb-bw-social:hover { background: rgba(0,0,0,0.1); transform: translateY(-1px); }
.pb-bw-social img,
.pb-bw-social svg { display: block; width: 13px; height: 13px; }
.pb-bw-divider { height: 1px; background: rgba(0,0,0,0.08); margin: 12px 0 11px; }
.pb-bw-desc {
...
/* ── Toolbar row: instruction input + send button ── */
.aid-toolbar {
  display: flex;
  align-items: center;
  gap: 12px;
...
/* ── Divider between toolbar and text field ── */
.aid-divider {
  height: 0;
  border: none;
