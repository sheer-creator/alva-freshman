...
.feeds-popover-bulk {
    ...
    background: var(--b-common-white, #fff);
    font-family: inherit;
    font-size: 12px; line-height: 20px; letter-spacing: 0.12px;
    color: var(--text-n9);
    cursor: pointer;
...
.feeds-popover-bulk:hover { border-color: var(--text-n9); }
.feeds-popover-bulk:active { border-color: var(--line-l3); background: var(--b-r02); }
...
.feeds-popover-bulk-icon.ic-play {
    -webkit-mask-image: url('https://alva-ai-static.b-cdn.net/icons/play-l.svg');
            mask-image: url('https://alva-ai-static.b-cdn.net/icons/play-l.svg');
}
.feeds-popover-row {
    font-size: 14px; line-height: 22px; letter-spacing: 0.14px;
...
.feeds-popover-cell-last { width: 100px; flex-shrink: 0; }
.feeds-popover-row-toggle {
    display: inline-flex; align-items: center; justify-content: center;
    width: 20px; height: 20px;
    padding: 0;
    background: transparent; border: none; border-radius: var(--radius-ct-s, 4px);
    cursor: pointer;
    flex-shrink: 0;
    color: var(--text-n9);
    transition: background .15s;
...
.feeds-popover-row-toggle.is-placeholder { visibility: hidden; pointer-events: none; }
...
.feeds-popover-row.is-paused .feeds-popover-cell-name,
.feeds-popover-row.is-paused .feeds-popover-cell-interval,
.feeds-popover-row.is-paused .feeds-popover-cell-last { color: var(--text-n5); }
