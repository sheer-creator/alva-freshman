import{j as t,P as n}from"./index-JJWnnUDq.js";import{A as a}from"./AppShell-ZMhBcxFd.js";import{i}from"./inlinePlaybookHeader-C8-yLGm1.js";import"./referral-mock-DJxnAaFy.js";const s=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  ...
  <style>
    ...
    *::-webkit-scrollbar { display: none; }
    ...
    @media (max-width: 640px) {
      ...
      .paywall-feed { padding: 40px 20px 110px; -webkit-overflow-scrolling: touch; }
      .pw-max { gap: 40px; max-width: none; margin: 0; }
      .purchase { gap: 20px; }
      .pu-benefits { gap: 8px; }
      .pu-row { gap: 8px; font-size: 14px; line-height: 22px; letter-spacing: 0.14px; color: var(--text-n7, rgba(0,0,0,0.7)); }
      .pu-row .ic { width: 20px; height: 20px; margin-top: 1px; }
      ...
      .pw-msg:last-child { width: 100%; height: 300px; animation-delay: 0.15s; }
      .pw-bubble { height: 100%; overflow: hidden; }
