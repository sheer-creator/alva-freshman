import{r as u,j as e}from"./index-BWuGy9it.js";import{A as N}from"./AppShell-5OVkeGGA.js";import"./referral-mock-d82NRrxd.js";const T=[{id:"overview",label:"Overview",level:1},{id:"installation",label:"Installation & Setup",level:1},{id:"filesystem",label:"Filesystem",level:1},{id:"js-runtime",label:"JS Runtime",level:1},{id:"sdkhub",label:"SDK Hub",level:2},{id:"feed-sdk",label:"Feed SDK",level:1},{id:"trading-engine",label:"Trading Engine",level:1},{id:"deployment",label:"Deployment",level:1},{id:"pitfalls",label:"Common Pitfalls",level:1},{id:"limits",label:"Resource Limits",level:1},{id:"errors",label:"Error Responses",level:1}];function o({code:a,lang:i="bash"}){const[n,d]=u.useState(!1),h=()=>{navigator.clipboard.writeText(a),d(!0),setTimeout(()=>d(!1),2e3)};return e.jsxs("div",{className:"relative group rounded-[6px] overflow-hidden my-[16px]",children:[e.jsxs("div",{className:"flex items-center justify-between px-[16px] py-[8px] bg-[#1a1b1e] border-b border-white/5",children:[e.jsx("span",{className:"text-[11px] text-white/30 font-mono uppercase tracking-wider",children:i}),e.jsx("button",{onClick:h,className:"text-[11px] text-white/30 hover:text-white/60 transition-colors font-mono cursor-pointer",children:n?"Copied!":"Copy"})]}),e.jsx("pre",{className:"bg-[#111214] px-[16px] py-[14px] overflow-x-auto",children:e.jsx("code",{className:"text-[13px] leading-[22px] text-[#e4e4e7] font-mono whitespace-pre",children:a})})]})}function l({headers:a,rows:i}){return e.jsx("div",{className:"overflow-x-auto my-[16px] rounded-[6px] border border-black/[0.06]",children:e.jsxs("table",{className:"w-full text-[13px] leading-[20px]",children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-black/[0.02]",children:a.map((n,d)=>e.jsx("th",{className:"text-left px-[12px] py-[10px] font-medium text-black/70 border-b border-black/[0.06] font-['Delight',sans-serif]",children:n},d))})}),e.jsx("tbody",{children:i.map((n,d)=>e.jsx("tr",{className:d%2===1?"bg-black/[0.015]":"",children:n.map((h,j)=>e.jsx("td",{className:"px-[12px] py-[8px] text-black/60 border-b border-black/[0.04] font-['Delight',sans-serif]",children:e.jsx("code",{className:"text-[12px] font-mono",children:h})},j))},d))})]})})}function c({id:a,children:i}){return e.jsx("h1",{id:a,className:"text-[28px] font-medium leading-[36px] text-black/90 mt-[48px] mb-[16px] font-['Delight',sans-serif] scroll-mt-[32px]",children:i})}function A({id:a,children:i}){return e.jsx("h2",{id:a,className:"text-[22px] font-medium leading-[30px] text-black/90 mt-[40px] mb-[12px] font-['Delight',sans-serif] scroll-mt-[32px]",children:i})}function t({children:a}){return e.jsx("h3",{className:"text-[18px] font-medium leading-[26px] text-black/80 mt-[32px] mb-[8px] font-['Delight',sans-serif]",children:a})}function r({children:a}){return e.jsx("p",{className:"text-[14px] leading-[24px] text-black/60 mb-[12px] font-['Delight',sans-serif]",children:a})}function s({children:a}){return e.jsx("code",{className:"text-[13px] bg-black/[0.04] px-[5px] py-[2px] rounded-[3px] font-mono text-black/70",children:a})}function S({activeId:a}){return e.jsxs("nav",{className:"hidden xl:block w-[200px] shrink-0 sticky top-[32px] self-start",children:[e.jsx("p",{className:"text-[11px] uppercase tracking-[1px] text-black/30 mb-[12px] font-['Delight',sans-serif]",children:"On this page"}),e.jsx("ul",{className:"flex flex-col gap-[2px]",children:T.map(i=>e.jsx("li",{children:e.jsx("button",{onClick:()=>{var n;return(n=document.getElementById(i.id))==null?void 0:n.scrollIntoView({behavior:"smooth",block:"start"})},className:`block text-left w-full text-[13px] leading-[28px] transition-colors font-['Delight',sans-serif] cursor-pointer ${i.level===2?"pl-[12px]":""} ${a===i.id?"text-[var(--main-m1)] font-medium":"text-black/40 hover:text-black/70"}`,children:i.label})},i.id))})]})}function f({icon:a,title:i,desc:n}){return e.jsxs("div",{className:"flex gap-[12px] items-start p-[16px] rounded-[8px] bg-black/[0.02] border border-black/[0.04]",children:[e.jsx("span",{className:"text-[20px] shrink-0 mt-[2px]",children:a}),e.jsxs("div",{children:[e.jsx("p",{className:"text-[14px] font-medium text-black/80 font-['Delight',sans-serif]",children:i}),e.jsx("p",{className:"text-[13px] text-black/50 font-['Delight',sans-serif] mt-[2px]",children:n})]})]})}function w(){const[a,i]=u.useState(!1),n="npm install -g @anthropic/open-alva";return e.jsxs("div",{onClick:()=>{navigator.clipboard.writeText(n),i(!0),setTimeout(()=>i(!1),2e3)},className:"inline-flex items-center gap-[12px] bg-[#111214] rounded-[8px] px-[20px] py-[12px] cursor-pointer hover:bg-[#1a1b1e] transition-colors",children:[e.jsx("code",{className:"text-[14px] text-[#e4e4e7] font-mono",children:n}),e.jsx("span",{className:"text-[12px] text-white/30",children:a?"Copied!":"Click to copy"})]})}function C({onNavigate:a,onOpenSearch:i}){const[n,d]=u.useState("overview"),h=u.useRef(null),j=u.useCallback(()=>{var x;(x=h.current)==null||x.disconnect();const p=T.map(m=>document.getElementById(m.id)).filter(Boolean);p.length!==0&&(h.current=new IntersectionObserver(m=>{const v=m.filter(g=>g.isIntersecting);if(v.length>0){const g=v.reduce((b,y)=>b.boundingClientRect.top<y.boundingClientRect.top?b:y);d(g.target.id)}},{rootMargin:"-32px 0px -60% 0px",threshold:0}),p.forEach(m=>h.current.observe(m)))},[]);return u.useEffect(()=>{const p=setTimeout(j,100);return()=>{var x;clearTimeout(p),(x=h.current)==null||x.disconnect()}},[j]),e.jsx(e.Fragment,{children:e.jsx(N,{activePage:"docs",onNavigate:a,onOpenSearch:i,children:e.jsx("div",{className:"flex justify-center min-h-full",children:e.jsxs("div",{className:"flex gap-[48px] px-[28px] py-[64px] w-full max-w-[1100px]",children:[e.jsxs("article",{className:"flex-1 min-w-0 max-w-[800px]",children:[e.jsxs("div",{className:"mb-[48px]",children:[e.jsxs("div",{className:"flex items-center gap-[10px] mb-[8px]",children:[e.jsx("div",{className:"w-[8px] h-[8px] rounded-full bg-[var(--main-m1)]"}),e.jsx("span",{className:"text-[12px] uppercase tracking-[2px] text-black/30 font-['Delight',sans-serif]",children:"Documentation"})]}),e.jsx("h1",{className:"text-[36px] font-medium leading-[44px] text-black/90 mb-[12px] font-['Delight',sans-serif]",children:"Open Alva"}),e.jsx("p",{className:"text-[18px] leading-[28px] text-black/50 mb-[24px] font-['Delight',sans-serif]",children:"Financial data & quantitative trading platform for AI agents."}),e.jsx(w,{})]}),e.jsx(c,{id:"overview",children:"What is Open Alva"}),e.jsx(r,{children:"Open Alva exposes five core capabilities via REST APIs, giving your AI agent full access to financial data, computation, and trading infrastructure."}),e.jsxs("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-[12px] my-[20px]",children:[e.jsx(f,{icon:"📁",title:"Filesystem",desc:"Persistent storage with permissions, symlinks, and synth mounts for time series data."}),e.jsx(f,{icon:"⚡",title:"JS Runtime",desc:"V8 isolate with 250+ financial data SDKs, HTTP, and the Feed SDK."}),e.jsx(f,{icon:"📊",title:"SDK Hub",desc:"Technical indicators, crypto/stock data, on-chain metrics, macro data, and LLM access."}),e.jsx(f,{icon:"📈",title:"Trading Engine",desc:"Altra backtesting framework for event-driven quantitative strategies."}),e.jsx(f,{icon:"🚀",title:"Deployment",desc:"Schedule scripts as cronjobs for continuous data feeds and automated tasks."})]}),e.jsx(c,{id:"installation",children:"Installation & Setup"}),e.jsx(t,{children:"Configuration"}),e.jsxs(r,{children:["Create ",e.jsx(s,{children:"~/.alva/user.json"})," with your credentials:"]}),e.jsx(o,{lang:"json",code:`{
  "endpoint": "http://localhost:3000",
  "api_key": "alva_local_dev"
}`}),e.jsx(l,{headers:["Field","Required","Description"],rows:[["endpoint","yes","Alva API base URL"],["api_key","yes","Your API key (create via Alva web app)"],["user_id","no","Numeric user ID (GET /api/v1/me)"],["username","no","Your username"]]}),e.jsx(t,{children:"Authentication"}),e.jsxs(r,{children:["Every request requires the ",e.jsx(s,{children:"X-Alva-Api-Key"})," header:"]}),e.jsx(o,{code:`curl -s -H "X-Alva-Api-Key: $ALVA_API_KEY" "$ALVA_ENDPOINT/api/v1/me"
# Response: {"id":1,"username":"alice"}`}),e.jsx(t,{children:"Load Config from Shell"}),e.jsx(o,{code:`if [ -f ~/.alva/user.json ]; then
  export ALVA_ENDPOINT=$(jq -r '.endpoint' ~/.alva/user.json)
  export ALVA_API_KEY=$(jq -r '.api_key' ~/.alva/user.json)
fi`}),e.jsx(c,{id:"filesystem",children:"Filesystem"}),e.jsxs(r,{children:["Persistent storage with support for permissions, symlinks, and synth mounts. Paths use home-relative format (",e.jsx(s,{children:"~/data/file.json"}),") or absolute (",e.jsx(s,{children:"/alva/home/<uid>/..."}),")."]}),e.jsx(t,{children:"API Endpoints"}),e.jsx(l,{headers:["Method","Endpoint","Description"],rows:[["GET","/api/v1/fs/read?path={path}","Read file content or time series"],["POST","/api/v1/fs/write","Write file content (raw or JSON)"],["GET","/api/v1/fs/stat?path={path}","Get file/directory metadata"],["GET","/api/v1/fs/readdir?path={path}","List directory entries"],["POST","/api/v1/fs/mkdir","Create directory (recursive)"],["DELETE","/api/v1/fs/remove?path={path}","Remove file or directory"],["POST","/api/v1/fs/rename","Rename / move"],["POST","/api/v1/fs/copy","Copy file"],["POST","/api/v1/fs/symlink","Create symlink"],["POST","/api/v1/fs/chmod","Change permissions"],["POST","/api/v1/fs/grant","Grant read/write access"],["POST","/api/v1/fs/revoke","Revoke access"]]}),e.jsx(t,{children:"Path Conventions"}),e.jsx(l,{headers:["Path","Purpose"],rows:[["~/tasks/<name>/src/","Task source code"],["~/feeds/<name>/v1/src/","Feed script source"],["~/feeds/<name>/v1/data/","Feed synth mount (auto-created)"],["~/data/","General data storage"],["~/library/","Shared code modules"]]}),e.jsx(t,{children:"Time Series Virtual Paths"}),e.jsx(r,{children:"When reading from synth mounts, append these suffixes to query time series data:"}),e.jsx(l,{headers:["Suffix","Description","Example"],rows:[["@last/{n}","Last N points (chronological)",".../prices/@last/100"],["@range/{start}..{end}","Between timestamps",".../prices/@range/2026-01-01T00:00:00Z..2026-03-01T00:00:00Z"],["@range/{duration}","Recent data within duration",".../prices/@range/7d"],["@count","Data point count",".../prices/@count"],["@now","Latest single data point",".../prices/@now"],["@all","All data points (paginated)",".../prices/@all"],["@append","Append data points (write)",".../prices/@append"],["@at/{ts}","Point nearest timestamp",".../prices/@at/1737988200"],["@before/{ts}/{limit}","Points before timestamp",".../prices/@before/1737988200/10"],["@after/{ts}/{limit}","Points after timestamp",".../prices/@after/1737988200/10"]]}),e.jsx(c,{id:"js-runtime",children:"JS Runtime"}),e.jsxs(r,{children:["Execute JavaScript in a V8 isolate via ",e.jsx(s,{children:"POST /api/v1/run"}),". Scripts have access to built-in modules and 250+ data SDKs from the Hub."]}),e.jsx(t,{children:"Run API"}),e.jsx(l,{headers:["Field","Type","Required","Description"],rows:[["code","string","* (one of)","Inline JavaScript to execute"],["entry_path","string","* (one of)","Path to script on filesystem"],["working_dir","string","no","Working directory for require()"],["args","object","no",'JSON accessible via require("env").args']]}),e.jsx(t,{children:"Built-in Modules"}),e.jsx(l,{headers:["Module","Import","Description"],rows:[["alfs",'require("alfs")',"Filesystem (absolute paths)"],["env",'require("env")',"userId, args from request"],["net/http",'require("net/http")',"fetch(url, init) for HTTP"],["@alva/algorithm",'require("@alva/algorithm")',"Technical indicators & statistics"],["@alva/feed",'require("@alva/feed")',"Feed SDK for data pipelines"],["@alva/llm",'require("@alva/llm")',"llmAsk, llmGenerate"],["@test/suite",'require("@test/suite")',"Jest-style test framework"]]}),e.jsx(t,{children:"Algorithm Module"}),e.jsx(o,{lang:"javascript",code:`const { jStat, indicators, backtest } = require('@alva/algorithm');
...
const bars = result.response.data;`}),e.jsxs(r,{children:["Most SDK functions are ",e.jsx("strong",{children:"synchronous"})," and return ",e.jsx(s,{children:"{ success, response: { data: [...] } }"}),"."]}),e.jsx(c,{id:"feed-sdk",children:"Feed SDK"}),e.jsx(r,{children:"Build persistent data pipelines with time series storage. Feeds define output schemas, fetch data, and append records to synth-mounted time series."}),e.jsx(t,{children:"Quick Start"}),e.jsx(o,{lang:"javascript",code:`const { Feed, feedPath, makeDoc, num } = require('@alva/feed');
  ...
  data/               # Synth mount (auto-created)
    metrics/
      prices/         # Time series output
        ...
        @count        # Virtual: point count`}),e.jsx(c,{id:"trading-engine",children:"Trading Engine (Altra)"}),e.jsx(r,{children:"Event-driven backtesting engine. All decisions happen at bar CLOSE. The architecture flows through four stages:"}),e.jsx("div",{className:"flex gap-[8px] items-center my-[20px] flex-wrap",children:["DataGraph","SignalGraph","SimGraph","PerfGraph"].map((p,x)=>e.jsxs("div",{className:"flex items-center gap-[8px]",children:[e.jsx("div",{className:"px-[14px] py-[8px] rounded-[6px] bg-[#49a3a6]/10 border border-[#49a3a6]/20",children:e.jsx("span",{className:"text-[13px] font-medium text-[var(--main-m1)] font-['Delight',sans-serif]",children:p})}),x<3&&e.jsx("span",{className:"text-black/20",children:"→"})]},p))}),e.jsx(t,{children:"Setup"}),e.jsx(o,{lang:"javascript",code:`const { AltraModule, num, str, bool, obj, arr, fld, makeDoc } = require('@alva/graph');
...
}, ohlcvProvider);`}),e.jsx(t,{children:"DataGraph"}),e.jsx(o,{lang:"javascript",code:`const dg = altra.getDataGraph();
...
});`}),e.jsx(t,{children:"Strategy"}),e.jsx(o,{lang:"javascript",code:`altra.setStrategy(
...
altra.getActivationLogs();     // Detailed execution log`}),e.jsx(c,{id:"deployment",children:"Deployment"}),e.jsxs(r,{children:["Schedule scripts as cronjobs. Workflow: write script → test via ",e.jsx(s,{children:"/api/v1/run"})," → deploy as cronjob → monitor."]}),e.jsx(t,{children:"Cronjob API"}),e.jsx(l,{headers:["Method","Endpoint","Description"],rows:[["POST","/api/v1/deploy/cronjob","Create a cronjob"],["GET","/api/v1/deploy/cronjobs","List cronjobs (paginated)"],["GET","/api/v1/deploy/cronjob/:id","Get cronjob details"],["PATCH","/api/v1/deploy/cronjob/:id","Update (name, cron, args)"],["DELETE","/api/v1/deploy/cronjob/:id","Delete cronjob"],["POST","/api/v1/deploy/cronjob/:id/pause","Pause cronjob"],["POST","/api/v1/deploy/cronjob/:id/resume","Resume cronjob"]]}),e.jsx(t,{children:"Cron Expressions"}),e.jsx(l,{headers:["Expression","Schedule"],rows:[["*/5 * * * *","Every 5 minutes"],["0 * * * *","Every hour"],["0 */4 * * *","Every 4 hours"],["0 0 * * *","Daily at midnight UTC"],["0 9 * * 1-5","Weekdays at 9:00 UTC"]]}),e.jsx(t,{children:"Example: Deploy a Feed"}),e.jsx(o,{code:`# Deploy a feed script as a cronjob (every 4 hours)
