...
Investing Playbooks in Minutes`;return o.useLayoutEffect(()=>{const w=f.current,E=v.current;if(!w||!E)return;const M=()=>{E.style.maxWidth=`${w.clientWidth}px`;const L=E.scrollHeight;y(L>b?b/L:1)};M();const B=new ResizeObserver(M);return B.observe(w),()=>B.disconnect()},[h,b]),o.useEffect(()=>{const w=m.current;if(w===h){m.current=h;return}m.current=h;const E=f.current,M=v.current,B=k.current,L=d.current},[h]),e.jsxs("div",{ref:f,style:{position:"relative",width:"100%",maxWidth:i,height:b,display:"flex",alignItems:"center",justifyContent:"center",overflow:"visible"},children:[e.jsx("style",{children:`
      ...
      `}),e.jsx("h1",{ref:k,"aria-hidden":!0,style:{position:"absolute",left:0,right:0,top:"50%",transform:`translateY(-50%) scale(${p})`,transformOrigin:"center",fontSize:n,lineHeight:ae,fontWeight:400,color:"var(--text-n9)",textAlign:"center",letterSpacing:.45,margin:0,pointerEvents:"none",zIndex:1}}),e.jsx("h1",{ref:v,style:{fontSize:n,lineHeight:ae,fontWeight:400,color:"var(--text-n9)",textAlign:"center",letterSpacing:.45,margin:0,transform:`scale(${p})`,transformOrigin:"center",position:"relative",zIndex:1,whiteSpace:"pre-line"},children:h}),e.jsx("div",{ref:d,"aria-hidden":!0,style:{position:"absolute",inset:0,pointerEvents:"none",zIndex:2,overflow:"visible"}})]})}function zt({template:t,onClose:i,onSelect:s}){const c=t.tags??oe(t.id);return typeof document>"u"?null:Te.createPortal(e.jsx("div",{onClick:i,style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",padding:16,animation:"newchat-fade 160ms ease-out"},children:e.jsxs("div",{onClick:n=>n.stopPropagation(),style:{width:"100%",maxWidth:360,background:"#ffffff",borderRadius:14,padding:20,boxShadow:"0 20px 48px rgba(0,0,0,0.18), 0 6px 14px rgba(0,0,0,0.08)",animation:"newchat-fadeup 220ms ease-out"},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:4},children:[e.jsx("h2",{style:{fontFamily:"'Delight', sans-serif",fontSize:18,lineHeight:"24px",fontWeight:500,color:"var(--text-n9)",letterSpacing:.18,margin:0},children:t.label}),e.jsx("span",{style:{fontFamily:"'Delight', sans-serif",fontSize:11,lineHeight:"16px",color:"rgba(0,0,0,0.4)",letterSpacing:.11,fontWeight:500},children:Ae(t.id)})]}),e.jsx("p",{style:{fontFamily:"'Delight', sans-serif",fontSize:13,lineHeight:"20px",color:"var(--text-n7)",letterSpacing:.13,margin:"10px 0 0"},children:t.description}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:5,flexWrap:"wrap",marginTop:10},children:c.slice(0,3).map(n=>e.jsx("span",{style:{height:20,padding:"0 6px",borderRadius:5,background:"var(--b-r05)",color:"var(--text-n5)",fontFamily:"'Delight', sans-serif",fontSize:11,lineHeight:"20px",letterSpacing:.11,whiteSpace:"nowrap"},children:n},n))}),e.jsx("div",{style:{height:1,background:"var(--line-l07)",margin:"20px 0 12px"}}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12},children:[e.jsxs("div",{style:{flex:1,minWidth:0,display:"flex",alignItems:"center",gap:10},children:[e.jsx(j,{name:t.creator,size:36}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("div",{style:{fontFamily:"'Delight', sans-serif",fontSize:11,lineHeight:"14px",color:"var(--text-n5)",letterSpacing:.11,fontWeight:500},children:"Created by"}),e.jsx("div",{style:{fontFamily:"'Delight', sans-serif",fontSize:14,lineHeight:"20px",color:"var(--text-n9)",letterSpacing:.14,fontWeight:500,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:t.creator})]})]}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:6,flexShrink:0},children:le(t.creator).map(n=>e.jsx("a",{href:n.href,target:"_blank",rel:"noreferrer noopener","aria-label":n.label,style:{width:24,height:24,borderRadius:"9999px",background:"var(--b-r05)",display:"inline-flex",alignItems:"center",justifyContent:"center",flexShrink:0},children:n.render()},n.key))})]}),e.jsx("div",{style:{height:1,background:"var(--line-l07)",margin:"12px 0 20px"}}),e.jsx("button",{type:"button",onClick:s,style:{width:"100%",height:44,border:"none",borderRadius:10,background:"var(--main-m1)",color:"#fff",fontFamily:"'Delight', sans-serif",fontSize:14,fontWeight:500,letterSpacing:.14,cursor:"pointer"},children:"Pick this skill"})]})}),document.body)}const Bt=340,se=16;function Ot({onNavigate:t}){const[i,s]=o.useState("Popular"),[c,n]=o.useState(()=>new Set),l=o.useRef(null),[b,f]=o.useState(0);o.useEffect(()=>{if(!l.current)return;const m=l.current,p=new ResizeObserver(y=>{var w;const h=((w=y[0])==null?void 0:w.contentRect.width)??0;f(h)});return p.observe(m),()=>p.disconnect()},[]);const v=m=>{n(p=>{const y=new Set(p);return y.has(m)?y.delete(m):y.add(m),y})},k=o.useMemo(()=>{const m=i==="Recent"?[...fe].reverse():fe;return c.size===0?m:m.filter(p=>{for(const y of c)if(qe(y,p))return!0;return!1})},[i,c]),d=b===0?{display:"grid",gap:se,width:"100%"}:{display:"grid",gridTemplateColumns:`repeat(${Math.max(1,Math.floor((b+se)/Bt))}, minmax(0, 1fr))`,gap:se,width:"100%"};return e.jsx("section",{style:{width:"100%",padding:"40px 28px 60px",position:"relative",zIndex:2},children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%"},children:[e.jsx("p",{style:{fontFamily:"'Delight', sans-serif",fontSize:20,lineHeight:"30px",letterSpacing:.2,color:"var(--text-n9)"},children:"Trending Playbooks"}),e.jsxs("button",{type:"button",onClick:()=>t("explore"),style:{display:"inline-flex",alignItems:"center",gap:4,height:28,padding:"4px 0",background:"transparent",border:"none",cursor:"pointer",fontFamily:"'Delight', sans-serif",fontSize:12,lineHeight:"20px",letterSpacing:.12,color:"var(--text-n9)"},children:["View all",e.jsx(D,{name:"arrow-right-l2",size:14,color:"var(--text-n9)"})]})]}),e.jsx(We,{sort:i,sortOptions:Ye,chips:Ge,onSortChange:s,selectedChips:c,onChipToggle:v}),e.jsx("div",{ref:l,style:d,children:k.map((m,p)=>e.jsx("div",{style:{width:"100%"},children:e.jsx(_e,{p:m,staggerMs:p%10*1e3})},m.id))})]})})}const N=960;function _t({onNavigate:t}){var he;const[i,s]=o.useState(null),[c,n]=o.useState(null),[l,b]=o.useState(""),[f,v]=o.useState(""),[k,d]=o.useState(null),[m,p]=o.useState(!1),[y,h]=o.useState(null);o.useEffect(()=>{if(typeof document>"u")return;const r=!!y||m;return document.body.classList.toggle("nc-overlay-open",r),()=>{document.body.classList.remove("nc-overlay-open")}},[y,m]);const[w,E]=o.useState(()=>typeof window<"u"?window.innerWidth<640:!1);o.useEffect(()=>{const r=()=>E(window.innerWidth<640);return r(),window.addEventListener("resize",r),()=>window.removeEventListener("resize",r)},[]);const M=o.useRef(null),B=o.useRef(null),L=o.useRef(null),ce=600,H=o.useRef(null),W=o.useRef(null),[X,V]=o.useState(null),_=()=>{H.current!==null&&(window.clearTimeout(H.current),H.current=null),W.current&&(document.removeEventListener("mousemove",W.current),W.current=null),V(null)},Ce=(r,u,A,S)=>{_(),V({x:A,y:S});const R=I=>V({x:I.clientX,y:I.clientY});document.addEventListener("mousemove",R),W.current=R,H.current=window.setTimeout(()=>{_(),de(r,u.getBoundingClientRect())},ce)},G=()=>{L.current!==null&&(window.clearTimeout(L.current),L.current=null)},q=()=>{G(),L.current=window.setTimeout(()=>d(null),160)},de=(r,u,A="auto")=>{if(A==="left"){G(),d({id:r,rect:u,placeAbove:!1,side:"left"});return}let S=!1;M.current&&M.current.querySelectorAll('button, [role="button"]').forEach(I=>{I.getBoundingClientRect().top>u.bottom-1&&(S=!0)}),G(),d({id:r,rect:u,placeAbove:S,side:"auto"})},[Me,$]=o.useState(!1),[De,U]=o.useState(!1);o.useEffect(()=>{const r=setTimeout(()=>v(l),700);return()=>clearTimeout(r)},[l]),o.useEffect(()=>{if(!m)return;const r=u=>{u.key==="Escape"&&p(!1)};return document.addEventListener("keydown",r),()=>document.removeEventListener("keydown",r)},[m]),o.useEffect(()=>{if(!i){$(!1),U(!1);return}$(!1),U(!1);const r=setTimeout(()=>$(!0),900),u=setTimeout(()=>U(!0),1500);return()=>{clearTimeout(r),clearTimeout(u)}},[i]);const pe=o.useMemo(()=>st(f),[f]),Q=!i&&pe.length>0,x=o.useMemo(()=>i&&(ee.find(r=>r.id===i)||te.find(r=>r.id===i)||re.find(r=>r.id===i))||null,[i]),Y=o.useMemo(()=>[...ee,...te,...re],[]),je=o.useRef(null),[K,Ee]=o.useState(new Set);o.useLayoutEffect(()=>{const r=()=>{const A=M.current;if(!A)return;const S=Array.from(A.querySelectorAll("button[data-skill-id]")),R=A.querySelector("[data-more-wrap]");if(!R)return;S.forEach(P=>{P.style.display=""}),R.style.display="";const I=[],ge=i?2:3,Be=()=>{const F=[...new Set([...S.filter(z=>z.style.display!=="none").map(z=>z.offsetTop),R.offsetTop])].sort((z,Z)=>z-Z).indexOf(R.offsetTop);return F>=0&&F<=ge-1};let Oe=S.length;for(;Oe-- >0&&!Be();){const P=S.filter(Z=>Z.style.display!=="none");if(P.length===0)break;const F=P[P.length-1],z=F.dataset.skillId;z&&I.push(z),F.style.display="none",A.offsetWidth}I.length===0&&(R.style.display="none");const J=new Set(I);J.size===K.size&&[...J].every(P=>K.has(P))||Ee(J)};r();const u=new ResizeObserver(r);return M.current&&u.observe(M.current),window.addEventListener("resize",r),()=>{u.disconnect(),window.removeEventListener("resize",r)}},[Y,K,i]);const Le=r=>{if(w){h(r),p(!1),d(null);return}s(u=>u===r?null:r),d(null),p(!1)},Re=r=>{s(u=>u===r?null:r),d(null),p(!1)},Ie=()=>{y&&(s(y),h(null),p(!1))},Pe=()=>s(null),me=r=>n({text:r,seq:Date.now()}),ze=r=>{t(r==="__agent__"?"agent":`thread/${r}`)},ue=k?ee.find(r=>r.id===k.id)||te.find(r=>r.id===k.id)||re.find(r=>r.id===k.id):null;return e.jsxs(Fe,{activePage:"new-chat",onNavigate:t,children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"h-screen overflow-y-auto relative",style:{backgroundColor:"var(--b0-container, #ffffff)"},children:[e.jsx("div",{className:"flex items-center gap-[16px] h-[56px] px-[28px] shrink-0 newchat-page-topbar",style:{position:"sticky",top:0,zIndex:5,background:"var(--b0-container, #ffffff)"},children:e.jsx("div",{className:"flex-1 min-w-0",children:e.jsx(Ne,{activeId:"new",onSelect:ze,trigger:e.jsxs("div",{className:"flex gap-[4px] items-center min-w-0 cursor-pointer",children:[e.jsx("p",{className:"font-['Delight',sans-serif] text-[14px] leading-[22px] tracking-[0.14px] text-[var(--text-n9)] truncate",children:"New Chat"}),e.jsx(D,{name:"arrow-down-f2",size:14,color:"var(--text-n2)"})]})})})}),e.jsxs("section",{className:"nc-hero-section",style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",gap:36,padding:"24px 28px",position:"relative",zIndex:2},children:[e.jsx(Pt,{selected:x,maxWidth:N}),e.jsx("div",{className:"nc-chatbox-wrap",style:{width:"100%",maxWidth:N,position:"relative",zIndex:1},children:e.jsx(He,{shadow:!0,hideSkill:!0,hideInspector:!0,allowReferences:!1,bottomChip:x?{label:x.label,icon:x.kol?void 0:x.icon??nt,avatar:x.kol?x.creator:void 0,creator:x.creator,onRemove:Pe,onHover:r=>de(x.id,r),onLeave:q}:null,injectText:c,onInputChange:b})}),Q&&e.jsx("div",{className:"nc-prompts-container",style:{width:"100%",maxWidth:N,position:"relative",zIndex:1,marginTop:-16,display:"flex",flexDirection:"column"},children:pe.map((r,u)=>e.jsx("div",{style:{animation:"newchat-fadeup 320ms ease-out both",animationDelay:`${u*110}ms`},children:e.jsx(ke,{text:r,onClick:()=>me(r)})},u))},f),!Q&&e.jsxs("div",{ref:M,style:{display:"flex",flexWrap:"wrap",gap:12,justifyContent:"center",paddingTop:12,position:"relative",zIndex:1,width:"100%",maxWidth:900},children:[Y.map(r=>{var A;const u=i===r.id;return e.jsxs("button",{"data-skill-id":r.id,className:"nc-pill",onClick:()=>Le(r.id),onMouseEnter:S=>{C()&&(S.currentTarget.style.boxShadow="0 4px 12px rgba(0,0,0,0.05)",S.currentTarget.style.transform="translateY(-2px)",Ce(r.id,S.currentTarget,S.clientX,S.clientY))},onMouseLeave:S=>{C()&&(S.currentTarget.style.boxShadow="none",S.currentTarget.style.transform="translateY(0)",_(),q())},style:{...O,background:u?"rgba(0,0,0,0.7)":"white",color:u?"rgba(255,255,255,0.9)":O.color,borderColor:u?"rgba(0,0,0,0.7)":((A=O.border)==null?void 0:A.replace("0.5px solid ",""))??void 0},children:[r.kol?e.jsx(j,{name:r.creator,size:22}):r.icon&&e.jsx(D,{name:r.icon,size:18,color:u?"#fff":"var(--text-n9)"}),r.label]},r.id)}),e.jsx("div",{ref:B,"data-more-wrap":!0,style:{position:"relative"},children:e.jsxs("button",{ref:je,type:"button",className:"nc-pill","aria-expanded":m,"aria-label":"More skills",style:{...O,cursor:"pointer",background:m?"#f3f8f8":"white",border:m?"0.5px solid rgba(73,163,166,0.45)":O.border},onMouseEnter:r=>{C()&&(r.currentTarget.style.boxShadow="0 4px 12px rgba(0,0,0,0.05)",r.currentTarget.style.transform="translateY(-2px)")},onMouseLeave:r=>{C()&&(r.currentTarget.style.boxShadow="none",r.currentTarget.style.transform="translateY(0)")},onClick:()=>{p(r=>!r),d(null)},children:["More",e.jsx(D,{name:"arrow-right-l2",size:14,color:"var(--text-n5)"})]})})]}),x&&e.jsx("div",{className:"nc-prompts-container",style:{width:"100%",maxWidth:N,position:"relative",zIndex:1,marginTop:0,display:"flex",flexDirection:"column"},children:Me?e.jsx("div",{className:"nc-prompts-list",style:{animation:"newchat-fade 280ms ease-out"},children:x.prompts.slice(0,3).map((r,u)=>e.jsx(ke,{text:r,index:u,onClick:()=>me(r)},u))}):e.jsxs("div",{className:"nc-prompts-list nc-skeleton-anim",style:{animation:"newchat-fade 200ms ease-out"},children:[e.jsx(ie,{widthPct:92}),e.jsx(ie,{widthPct:70}),e.jsx(ie,{widthPct:82})]})}),x&&e.jsx("div",{style:{width:"100%",maxWidth:N,position:"relative",zIndex:2},children:De?x.recCards?e.jsx("div",{style:{display:"grid",gridTemplateColumns:`repeat(${x.recCards.length}, minmax(0, 1fr))`,gap:16,animation:"newchat-fade 320ms ease-out"},children:x.recCards.map((r,u)=>{const A=r.type==="playbook"?r.playbook.id:r.push.id;return e.jsx("div",{style:{animation:"newchat-fadeup 360ms ease-out both",animationDelay:`${u*50}ms`},children:r.type==="playbook"?e.jsx(ve,{p:r.playbook,skillId:x.id,skillLabel:x.label,skillIcon:x.icon,skillKol:x.kol,skillCreator:x.creator,hideTags:!0,onClick:()=>{sessionStorage.setItem("autoOpenChatPanel","1"),t("new-chat")}}):e.jsx(et,{a:r.push})},A)})}):e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:12,animation:"newchat-fade 320ms ease-out"},children:x.playbooks.slice(0,6).map((r,u)=>e.jsx("div",{style:{animation:"newchat-fadeup 360ms ease-out both",animationDelay:`${u*50}ms`},children:e.jsx(ve,{p:r,skillId:x.id,skillLabel:x.label,skillIcon:x.icon,skillKol:x.kol,skillCreator:x.creator,onClick:()=>{sessionStorage.setItem("autoOpenChatPanel","1"),t("new-chat")}})},r.id))}):e.jsx("div",{className:"nc-skeleton-anim",style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:12,animation:"newchat-fade 200ms ease-out"},children:Array.from({length:((he=x.recCards)==null?void 0:he.length)??6}).map((r,u)=>e.jsx(Et,{},u))})},x.id)]}),!Q&&e.jsx(Ot,{onNavigate:t})]}),k&&ue&&e.jsx(ut,{template:ue,anchor:k.rect,placeAbove:k.placeAbove,side:k.side,onMouseEnter:G,onMouseLeave:q}),X&&e.jsxs("div",{"aria-hidden":!0,style:{position:"fixed",left:X.x+14,top:X.y+14,width:16,height:16,pointerEvents:"none",zIndex:9999},children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",style:{display:"block"},children:[e.jsx("circle",{cx:"8",cy:"8",r:"6",fill:"none",stroke:"rgba(0,0,0,0.12)",strokeWidth:"1.6"}),e.jsx("circle",{cx:"8",cy:"8",r:"6",fill:"none",stroke:"var(--main-m1)",strokeWidth:"1.6",strokeLinecap:"round",strokeDasharray:2*Math.PI*6,strokeDashoffset:2*Math.PI*6,transform:"rotate(-90 8 8)",style:{animation:`nc-pill-ring-fill ${ce}ms linear forwards`}})]}),e.jsx("style",{children:`
            @keyframes nc-pill-ring-fill {
              from { stroke-dashoffset: ${2*Math.PI*6}; }
              to   { stroke-dashoffset: 0; }
            }
          `})]}),m&&e.jsx(Lt,{skills:Y,selectedId:i,onSelect:Re,onClose:()=>p(!1)}),y&&(()=>{const r=Y.find(u=>u.id===y);return r?e.jsx(zt,{template:r,onClose:()=>h(null),onSelect:Ie}):null})()]})}export{Vt as SkillPill,_t as default};
