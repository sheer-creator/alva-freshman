...
/* circled pause/play glyph: ring drawn by border, symbol by masked ::after */
...
.feeds-popover-bulk-icon.ic-pause::after {
...
.feeds-popover-bulk-icon.ic-play::after {
...
.feeds-popover-row-sub {
    display: flex; align-items: center; gap: 8px;
    padding-left: 20px; /* dot 14px + gap 6px — sub line aligns with the name text */
    font-size: 14px; line-height: 22px; letter-spacing: 0.14px;
    color: var(--text-n5, rgba(0,0,0,0.5));
}
