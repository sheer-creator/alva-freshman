...
Investing Playbooks in Minutes`;return o.useLayoutEffect(()=>{const f=x.current,C=k.current;if(!f||!C)return;const O=()=>{C.style.maxWidth=`${f.clientWidth}px`;const M=C.scrollHeight;y(M>b?b/M:1)};O();const z=new ResizeObserver(O);return z.observe(f),()=>z.disconnect()},[d,b]),o.useEffect(()=>{const f=u.current;if(f===d){u.current=d;return}u.current=d;const C=x.current,O=k.current,z=w.current,M=m.current},[d]),e.jsxs("div",{ref:x,style:{position:"relative",width:"100%",maxWidth:i,height:b,display:"flex",alignItems:"center",justifyContent:"center",overflow:"visible"},children:[e.jsx("style",{children:`
        ...
        .tr-cell{ position:absolute; width:${Se}px; height:${Se}px; opacity:0; pointer-events:none; }
      `}),e.jsx("h1",{ref:w,"aria-hidden":!0,style:{position:"absolute",left:0,right:0,top:"50%",transform:`translateY(-50%) scale(${g})`,transformOrigin:"center",fontSize:s,lineHeight:se,fontWeight:400,color:"var(--text-n9)",textAlign:"center",letterSpacing:.45,margin:0,pointerEvents:"none",zIndex:1}}),e.jsx("h1",{ref:k,style:{fontSize:s,lineHeight:se,fontWeight:400,color:"var(--text-n9)",textAlign:"center",letterSpacing:.45,margin:0,transform:`scale(${g})`,transformOrigin:"center",position:"relative",zIndex:1,whiteSpace:"pre-line"},children:d}),e.jsx("div",{ref:m,"aria-hidden":!0,style:{position:"absolute",inset:0,pointerEvents:"none",zIndex:2,overflow:"visible"}})]})}function zt({template:t,onClose:i,onSelect:n}){const c=t.tags??le(t.id);return typeof document>"u"?null:Te.createPortal(e.jsx("div",{onClick:i,style:{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",padding:16,animation:"newchat-fade 160ms ease-out"},children:e.jsxs("div",{onClick:s=>s.stopPropagation(),style:{width:"100%",maxWidth:360,background:"#ffffff",borderRadius:14,padding:20,boxShadow:"0 20px 48px rgba(0,0,0,0.18), 0 6px 14px rgba(0,0,0,0.08)",animation:"newchat-fadeup 220ms ease-out"},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:4},children:[e.jsx("h2",{style:{fontFamily:"'Delight', sans-serif",fontSize:18,lineHeight:"24px",fontWeight:500,color:"var(--text-n9)",letterSpacing:.18,margin:0},children:t.label}),e.jsx("span",{style:{fontFamily:"'Delight', sans-serif",fontSize:11,lineHeight:"16px",color:"rgba(0,0,0,0.4)",letterSpacing:.11,fontWeight:500},children:Ae(t.id)})]}),e.jsx("p",{style:{fontFamily:"'Delight', sans-serif",fontSize:13,lineHeight:"20px",color:"var(--text-n7)",letterSpacing:.13,margin:"10px 0 0"},children:t.description}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:5,flexWrap:"wrap",marginTop:10},children:c.slice(0,3).map(s=>e.jsx("span",{style:{height:20,padding:"0 6px",borderRadius:5,background:"var(--b-r05)",color:"var(--text-n5)",fontFamily:"'Delight', sans-serif",fontSize:11,lineHeight:"20px",letterSpacing:.11,whiteSpace:"nowrap"},children:s},s))}),e.jsx("div",{style:{height:1,background:"var(--line-l07)",margin:"20px 0 12px"}}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:12},children:[e.jsxs("div",{style:{flex:1,minWidth:0,display:"flex",alignItems:"center",gap:10},children:[e.jsx(L,{name:t.creator,size:36}),e.jsxs("div",{style:{minWidth:0},children:[e.jsx("div",{style:{fontFamily:"'Delight', sans-serif",fontSize:11,lineHeight:"14px",color:"var(--text-n5)",letterSpacing:.11,fontWeight:500},children:"Created by"}),e.jsx("div",{style:{fontFamily:"'Delight', sans-serif",fontSize:14,lineHeight:"20px",color:"var(--text-n9)",letterSpacing:.14,fontWeight:500,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:t.creator})]})]}),e.jsx("div",{style:{display:"flex",alignItems:"center",gap:6,flexShrink:0},children:ce(t.creator).map(s=>e.jsx("a",{href:s.href,target:"_blank",rel:"noreferrer noopener","aria-label":s.label,style:{width:24,height:24,borderRadius:"9999px",background:"var(--b-r05)",display:"inline-flex",alignItems:"center",justifyContent:"center",flexShrink:0},children:s.render()},s.key))})]}),e.jsx("div",{style:{height:1,background:"var(--line-l07)",margin:"12px 0 20px"}}),e.jsx("button",{type:"button",onClick:n,style:{width:"100%",height:44,border:"none",borderRadius:10,background:"var(--main-m1)",color:"#fff",fontFamily:"'Delight', sans-serif",fontSize:14,fontWeight:500,letterSpacing:.14,cursor:"pointer"},children:"Pick this skill"})]})}),document.body)}const Bt=340,ne=16;function Nt({onNavigate:t}){const[i,n]=o.useState("Popular"),[c,s]=o.useState(()=>new Set),l=o.useRef(null),[b,x]=o.useState(0);o.useEffect(()=>{if(!l.current)return;const u=l.current,g=new ResizeObserver(y=>{var f;const d=((f=y[0])==null?void 0:f.contentRect.width)??0;x(d)});return g.observe(u),()=>g.disconnect()},[]);const k=u=>{s(g=>{const y=new Set(g);return y.has(u)?y.delete(u):y.add(u),y})},w=o.useMemo(()=>{const u=i==="Recent"?[...fe].reverse():fe;return c.size===0?u:u.filter(g=>{for(const y of c)if(Ke(y,g))return!0;return!1})},[i,c]),m=b===0?{display:"grid",gap:ne,width:"100%"}:{display:"grid",gridTemplateColumns:`repeat(${Math.max(1,Math.floor((b+ne)/Bt))}, minmax(0, 1fr))`,gap:ne,width:"100%"};return e.jsx("section",{style:{width:"100%",padding:"40px 28px 60px",position:"relative",zIndex:2},children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",width:"100%"},children:[e.jsx("p",{style:{fontFamily:"'Delight', sans-serif",fontSize:20,lineHeight:"30px",letterSpacing:.2,color:"var(--text-n9)"},children:"Trending Playbooks"}),e.jsxs("button",{type:"button",onClick:()=>t("explore"),style:{display:"inline-flex",alignItems:"center",gap:4,height:28,padding:"4px 0",background:"transparent",border:"none",cursor:"pointer",fontFamily:"'Delight', sans-serif",fontSize:12,lineHeight:"20px",letterSpacing:.12,color:"var(--text-n9)"},children:["View all",e.jsx(j,{name:"arrow-right-l2",size:14,color:"var(--text-n9)"})]})]}),e.jsx(Ye,{sort:i,sortOptions:Ve,chips:Xe,onSortChange:n,selectedChips:c,onChipToggle:k}),e.jsx("div",{ref:l,style:m,children:w.map((u,g)=>e.jsx("div",{style:{width:"100%"},children:e.jsx(Je,{p:u,staggerMs:g%10*1e3})},u.id))})]})})}const F=960;function $t({onNavigate:t}){const[i,n]=o.useState(null),[c,s]=o.useState(null),[l,b]=o.useState(null),[x,k]=o.useState(""),[w,m]=o.useState(""),[u,g]=o.useState(null),[y,d]=o.useState(!1),[f,C]=o.useState(null);o.useEffect(()=>{if(typeof document>"u")return;const r=!!f||y;return document.body.classList.toggle("nc-overlay-open",r),()=>{document.body.classList.remove("nc-overlay-open")}},[f,y]);const[O,z]=o.useState(()=>typeof window<"u"?window.innerWidth<640:!1);o.useEffect(()=>{const r=()=>z(window.innerWidth<640);return r(),window.addEventListener("resize",r),()=>window.removeEventListener("resize",r)},[]);const M=o.useRef(null),Me=o.useRef(null),H=o.useRef(null),de=600,W=o.useRef(null),G=o.useRef(null),[V,_]=o.useState(null),q=()=>{W.current!==null&&(window.clearTimeout(W.current),W.current=null),G.current&&(document.removeEventListener("mousemove",G.current),G.current=null),_(null)},De=(r,p,D,S)=>{q(),_({x:D,y:S});const E=R=>_({x:R.clientX,y:R.clientY});document.addEventListener("mousemove",E),G.current=E,W.current=window.setTimeout(()=>{q(),pe(r,p.getBoundingClientRect())},de)},Y=()=>{H.current!==null&&(window.clearTimeout(H.current),H.current=null)},$=()=>{Y(),H.current=window.setTimeout(()=>g(null),160)},pe=(r,p,D="auto")=>{if(D==="left"){Y(),g({id:r,rect:p,placeAbove:!1,side:"left"});return}let S=!1;M.current&&M.current.querySelectorAll('button, [role="button"]').forEach(R=>{R.getBoundingClientRect().top>p.bottom-1&&(S=!0)}),Y(),g({id:r,rect:p,placeAbove:S,side:"auto"})},[je,U]=o.useState(!1),[Ee,Q]=o.useState(!1);o.useEffect(()=>{const r=setTimeout(()=>m(x),700);return()=>clearTimeout(r)},[x]),o.useEffect(()=>{if(!y)return;const r=p=>{p.key==="Escape"&&d(!1)};return document.addEventListener("keydown",r),()=>document.removeEventListener("keydown",r)},[y]),o.useEffect(()=>{if(!i){U(!1),Q(!1);return}U(!1),Q(!1);const r=setTimeout(()=>U(!0),900),p=setTimeout(()=>Q(!0),1500);return()=>{clearTimeout(r),clearTimeout(p)}},[i]);const ue=o.useMemo(()=>mt(w),[w]),J=!i&&ue.length>0,v=o.useMemo(()=>i&&(te.find(r=>r.id===i)||re.find(r=>r.id===i)||ie.find(r=>r.id===i))||null,[i]),X=o.useMemo(()=>[...te,...re,...ie],[]),Le=o.useRef(null),[K,Re]=o.useState(new Set);o.useLayoutEffect(()=>{const r=()=>{const D=M.current;if(!D)return;const S=Array.from(D.querySelectorAll("button[data-skill-id]")),E=D.querySelector("[data-more-wrap]");if(!E)return;S.forEach(I=>{I.style.display=""}),E.style.display="";const R=[],ge=i?2:3,Ne=()=>{const N=[...new Set([...S.filter(P=>P.style.display!=="none").map(P=>P.offsetTop),E.offsetTop])].sort((P,ee)=>P-ee).indexOf(E.offsetTop);return N>=0&&N<=ge-1};let Fe=S.length;for(;Fe-- >0&&!Ne();){const I=S.filter(ee=>ee.style.display!=="none");if(I.length===0)break;const N=I[I.length-1],P=N.dataset.skillId;P&&R.push(P),N.style.display="none",D.offsetWidth}R.length===0&&(E.style.display="none");const Z=new Set(R);Z.size===K.size&&[...Z].every(I=>K.has(I))||Re(Z)};r();const p=new ResizeObserver(r);return M.current&&p.observe(M.current),window.addEventListener("resize",r),()=>{p.disconnect(),window.removeEventListener("resize",r)}},[X,K,i]);const Ie=r=>{if(O){C(r),d(!1),g(null);return}n(p=>p===r?null:r),g(null),d(!1)},Pe=r=>{n(p=>p===r?null:r),g(null),d(!1)},Oe=()=>{f&&(n(f),C(null),d(!1))},ze=()=>n(null),me=r=>s({text:r,seq:Date.now()}),Be=r=>{t(r==="__agent__"?"agent":`thread/${r}`)},he=u?te.find(r=>r.id===u.id)||re.find(r=>r.id===u.id)||ie.find(r=>r.id===u.id):null;return e.jsxs(He,{activePage:"new-chat",onNavigate:t,children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"h-screen overflow-y-auto relative",style:{backgroundColor:"var(--b0-container, #ffffff)"},children:[e.jsx("div",{className:"flex items-center gap-[16px] h-[56px] px-[28px] shrink-0 newchat-page-topbar",style:{position:"sticky",top:0,zIndex:5,background:"var(--b0-container, #ffffff)"},children:e.jsx("div",{className:"flex-1 min-w-0",children:e.jsx(We,{activeId:"new",onSelect:Be,trigger:e.jsxs("div",{className:"flex gap-[4px] items-center min-w-0 cursor-pointer",children:[e.jsx("p",{className:"font-['Delight',sans-serif] text-[14px] leading-[22px] tracking-[0.14px] text-[var(--text-n9)] truncate",children:"New Chat"}),e.jsx(j,{name:"arrow-down-f2",size:14,color:"var(--text-n2)"})]})})})}),e.jsxs("section",{className:"nc-hero-section",style:{width:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",gap:36,padding:"24px 28px",position:"relative",zIndex:2},children:[e.jsx(Ot,{selected:v,maxWidth:F}),e.jsx("div",{className:"nc-chatbox-wrap",style:{width:"100%",maxWidth:F,position:"relative",zIndex:1},children:e.jsx(Ge,{shadow:!0,hideSkill:!0,hideInspector:!0,allowReferences:!1,bottomChip:v?{label:v.label,icon:v.kol?void 0:v.icon??ht,avatar:v.kol?v.creator:void 0,creator:v.creator,onRemove:ze,onHover:r=>pe(v.id,r),onLeave:$}:null,injectText:c,onInputChange:k})}),J&&e.jsx("div",{className:"nc-prompts-container",style:{width:"100%",maxWidth:F,position:"relative",zIndex:1,marginTop:-16,display:"flex",flexDirection:"column"},children:ue.map((r,p)=>e.jsx("div",{style:{animation:"newchat-fadeup 320ms ease-out both",animationDelay:`${p*110}ms`},children:e.jsx(ke,{text:r,onClick:()=>me(r)})},p))},w),!J&&e.jsxs("div",{ref:M,style:{display:"flex",flexWrap:"wrap",gap:12,justifyContent:"center",paddingTop:12,position:"relative",zIndex:1,width:"100%",maxWidth:900},children:[X.map(r=>{var D;const p=i===r.id;return e.jsxs("button",{"data-skill-id":r.id,className:"nc-pill",onClick:()=>Ie(r.id),onMouseEnter:S=>{A()&&(S.currentTarget.style.boxShadow="0 4px 12px rgba(0,0,0,0.05)",S.currentTarget.style.transform="translateY(-2px)",De(r.id,S.currentTarget,S.clientX,S.clientY))},onMouseLeave:S=>{A()&&(S.currentTarget.style.boxShadow="none",S.currentTarget.style.transform="translateY(0)",q(),$())},style:{...B,background:p?"rgba(0,0,0,0.7)":"white",color:p?"rgba(255,255,255,0.9)":B.color,borderColor:p?"rgba(0,0,0,0.7)":((D=B.border)==null?void 0:D.replace("0.5px solid ",""))??void 0},children:[r.kol?e.jsx(L,{name:r.creator,size:22}):r.icon&&e.jsx(j,{name:r.icon,size:18,color:p?"#fff":"var(--text-n9)"}),r.label]},r.id)}),e.jsx("div",{ref:Me,"data-more-wrap":!0,style:{position:"relative"},children:e.jsxs("button",{ref:Le,type:"button",className:"nc-pill","aria-expanded":y,"aria-label":"More skills",style:{...B,cursor:"pointer",background:y?"#f3f8f8":"white",border:y?"0.5px solid rgba(73,163,166,0.45)":B.border},onMouseEnter:r=>{A()&&(r.currentTarget.style.boxShadow="0 4px 12px rgba(0,0,0,0.05)",r.currentTarget.style.transform="translateY(-2px)")},onMouseLeave:r=>{A()&&(r.currentTarget.style.boxShadow="none",r.currentTarget.style.transform="translateY(0)")},onClick:()=>{d(r=>!r),g(null)},children:["More",e.jsx(j,{name:"arrow-right-l2",size:14,color:"var(--text-n5)"})]})})]}),v&&e.jsx("div",{className:"nc-prompts-container",style:{width:"100%",maxWidth:F,position:"relative",zIndex:1,marginTop:0,display:"flex",flexDirection:"column"},children:je?e.jsx("div",{className:"nc-prompts-list",style:{animation:"newchat-fade 280ms ease-out"},children:v.prompts.slice(0,3).map((r,p)=>e.jsx(ke,{text:r,index:p,onClick:()=>me(r)},p))}):e.jsxs("div",{className:"nc-prompts-list nc-skeleton-anim",style:{animation:"newchat-fade 200ms ease-out"},children:[e.jsx(ae,{widthPct:92}),e.jsx(ae,{widthPct:70}),e.jsx(ae,{widthPct:82})]})}),v&&e.jsx("div",{style:{width:"100%",maxWidth:F,position:"relative",zIndex:2},children:Ee?v.recCards?e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,animation:"newchat-fade 320ms ease-out"},children:[e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, minmax(0, 1fr))",gap:16},children:v.recCards.flatMap(r=>r.type==="playbook"?[r.playbook]:[]).slice(0,3).map((r,p)=>e.jsx("div",{style:{animation:"newchat-fadeup 360ms ease-out both",animationDelay:`${p*50}ms`},children:e.jsx(ve,{p:r,skillId:v.id,onClick:()=>{sessionStorage.setItem("autoOpenChatPanel","1"),t("new-chat")}})},r.id))}),e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(2, minmax(0, 1fr))",gap:16,gridAutoRows:281.5},children:v.recCards.flatMap(r=>r.type==="push"?[r.push]:[]).slice(0,2).map((r,p)=>e.jsx("div",{style:{animation:"newchat-fadeup 360ms ease-out both",animationDelay:`${(p+3)*50}ms`},children:e.jsx("div",{onClick:()=>b(r),style:{height:"100%",cursor:"pointer"},children:e.jsx(lt,{a:r})})},r.id))})]}):e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(280px, 1fr))",gap:16,animation:"newchat-fade 320ms ease-out"},children:v.playbooks.slice(0,6).map((r,p)=>e.jsx("div",{style:{animation:"newchat-fadeup 360ms ease-out both",animationDelay:`${p*50}ms`},children:e.jsx(ve,{p:r,skillId:v.id,onClick:()=>{sessionStorage.setItem("autoOpenChatPanel","1"),t("new-chat")}})},r.id))}):e.jsx("div",{className:"nc-skeleton-anim",style:{display:"grid",gridTemplateColumns:"repeat(3, minmax(0, 1fr))",gap:16,animation:"newchat-fade 200ms ease-out"},children:Array.from({length:3}).map((r,p)=>e.jsx(Lt,{},p))})},v.id)]}),!J&&e.jsx(Nt,{onNavigate:t})]}),u&&he&&e.jsx(bt,{template:he,anchor:u.rect,placeAbove:u.placeAbove,side:u.side,onMouseEnter:Y,onMouseLeave:$}),V&&e.jsxs("div",{"aria-hidden":!0,style:{position:"fixed",left:V.x+14,top:V.y+14,width:16,height:16,pointerEvents:"none",zIndex:9999},children:[e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",style:{display:"block"},children:[e.jsx("circle",{cx:"8",cy:"8",r:"6",fill:"none",stroke:"rgba(0,0,0,0.12)",strokeWidth:"1.6"}),e.jsx("circle",{cx:"8",cy:"8",r:"6",fill:"none",stroke:"var(--main-m1)",strokeWidth:"1.6",strokeLinecap:"round",strokeDasharray:2*Math.PI*6,strokeDashoffset:2*Math.PI*6,transform:"rotate(-90 8 8)",style:{animation:`nc-pill-ring-fill ${de}ms linear forwards`}})]}),e.jsx("style",{children:`
            @keyframes nc-pill-ring-fill {
              from { stroke-dashoffset: ${2*Math.PI*6}; }
              to   { stroke-dashoffset: 0; }
            }
          `})]}),y&&e.jsx(Rt,{skills:X,selectedId:i,onSelect:Pe,onClose:()=>d(!1)}),f&&(()=>{const r=X.find(p=>p.id===f);return r?e.jsx(zt,{template:r,onClose:()=>C(null),onSelect:Oe}):null})(),e.jsx(qe,{open:!!l,onClose:()=>b(null),feedName:(l==null?void 0:l.feedName)??"",description:"This automation runs on a fixed schedule and publishes new results to its subscribers. Each run pulls the latest data, applies the feed's logic, and writes a signal that powers the cards and alerts above. Open Settings → Automations to view full run logs and manage it."})]})}export{qt as SkillPill,$t as default};
