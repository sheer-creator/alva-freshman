...
.pb-bw-col { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: var(--spacing-xs);
}
...
.pb-bw-creator { display: flex; align-items: center; gap: var(--spacing-xs); min-width: 0; }
.pb-bw-avatar {
