...
`,s=`/* Alva Design Tokens — single source of truth.
...
`,p='<link rel="stylesheet" href="./styles/tokens.css" />',l='<link rel="stylesheet" href="./components/playbook-header.css" />',c='<script src="./components/playbook-header.js" defer><\/script>',d='<link rel="stylesheet" href="./components/discussion-panel.css" />',g='<script src="./components/discussion-panel.js" defer><\/script>';function e(n){return n.replace(/<\/script>/gi,"<\\/script>")}function t(n){return n.replace(/\/alva-infant\//g,"/")}function u(n){return n.replace(p,`<style>${s}</style>`).replace(l,`<style>${a}</style>`).replace(c,`<script>${e(t(r))}<\/script>`).replace(d,`<style>${i}</style>`).replace(g,`<script>${e(t(o))}<\/script>`)}export{u as i};
