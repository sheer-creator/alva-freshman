import{j as e,P as n}from"./index-C1tccH6p.js";import{A as a}from"./AppShell-CG4EPJdU.js";import{i as s}from"./inlinePlaybookHeader-Cld2A8Gm.js";import"./referral-mock-DJxnAaFy.js";const r=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8" />
...
`,o=s(r);function i(){return e.jsx("div",{className:"h-[calc(100dvh-56px)] lg:h-screen flex flex-col",style:{background:"var(--b0-page)"},children:e.jsx("div",{className:"flex-1 overflow-hidden",children:e.jsx("iframe",{srcDoc:o,title:n["template-whatif"],className:"block h-full w-full border-0"})})})}function _({onNavigate:t}){return e.jsx(a,{activePage:"template-whatif",onNavigate:t,children:e.jsx(i,{})})}export{_ as default};
