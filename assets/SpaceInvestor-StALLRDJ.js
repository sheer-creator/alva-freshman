import{j as t,P as n}from"./index-C_2GSu28.js";import{A as a}from"./AppShell-CSJ6le3R.js";import{i}from"./inlinePlaybookHeader-Cld2A8Gm.js";import"./referral-mock-DJxnAaFy.js";const s=`<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  ...
  <style>
    ...
    *::-webkit-scrollbar { display: none; }
    ...
    /* Stops are pixel-capped, not proportional: the sharp band at the top stays
       ~100px tall no matter how tall the veil gets (a percentage ramp would keep
       exposing more readable content as the window grows), and everything past
       ~700px sits at full blur. min(px, %) keeps short viewports proportional.
       Overlap zones compound (two backdrop layers cascade ≈ √(a²+b²)). */
    .pw-blur i:nth-child(1) { --b: 1.5px; --m0: 0px;              --m1: min(100px, 12.5%); --m2: min(300px, 37.5%); --m3: min(400px, 50%); }
    .pw-blur i:nth-child(2) { --b: 3px;   --m0: min(200px, 25%);  --m1: min(300px, 37.5%); --m2: min(500px, 62.5%); --m3: min(600px, 75%); }
    .pw-blur i:nth-child(3) { --b: 4px;   --m0: min(400px, 50%);  --m1: min(500px, 62.5%); --m2: min(700px, 87.5%); --m3: 100%; }
    .pw-blur i:nth-child(4) { --b: 5px;   --m0: min(600px, 75%);  --m1: min(700px, 87.5%); --m2: 100%;              --m3: 100%; }
    ...
    .pw-msg:not(:last-child) { margin-bottom: -88px; }
    .pw-msg.h200 { height: 200px; }  /* row is 200 while its 220 bubble hangs 20 under the next card */
    ...
    .pw-bubble { position: relative; flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 8px; height: 220px; overflow: hidden; padding: 12px; background: var(--b0-container, #fff); border: 0.5px solid var(--line-l12, rgba(0,0,0,0.12)); border-radius: var(--radius-ct-l, 8px); }
    ...
    @media (max-width: 640px) {
      ...
      .paywall-feed { padding: 40px 16px 110px; -webkit-overflow-scrolling: touch; }
      .pw-max { gap: 28px; max-width: none; margin: 0; }
      .purchase { gap: 20px; }
      .pu-benefits { gap: 8px; }
      .pu-lock { width: 56px; height: 56px; }
      .pu-lock img { width: 28px; height: 28px; }
      .pu-benefits { gap: 8px; }
    ...
    /* Touch: press feedback replaces hover; layered backdrop blur is too heavy */
    @media (hover: none) {
      ...
      .pw-blur i:nth-child(1), .pw-blur i:nth-child(2), .pw-blur i:nth-child(3) { display: none; }
      .pw-blur i:nth-child(4) { -webkit-mask-image: none; mask-image: none; -webkit-backdrop-filter: blur(8px); backdrop-filter: blur(8px); }
    }
  </style>
</head>
<body>
    ...
    <div class="paywall-feed">
      ...
      <div class="purchase">
        ...
        <div class="pu-benefits">
          <div class="pu-row"><span class="ic"></span><span>Full live dashboard<span class="pu-long"> — portfolio, charts, AI commentary</span></span></div>
