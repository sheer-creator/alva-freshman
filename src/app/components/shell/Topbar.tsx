  ...
  return (
    <div className="content-stretch flex gap-[12px] h-[56px] items-center py-[10px] sticky top-0 shrink-0 w-full z-10 bg-white">
      ...
      <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-h-px min-w-px relative">
        ...
        <div className="content-stretch flex flex-[1_0_0] gap-[4px] items-center min-h-px min-w-px relative">
          <p className="font-['Delight',sans-serif] leading-[22px] max-w-[136px] not-italic overflow-hidden relative shrink-0 text-[14px] text-[var(--text-n9)] text-ellipsis tracking-[0.14px]">Alva Intern</p>
          <div className="flex flex-col font-['Delight',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-[var(--text-n5)] text-center tracking-[0.12px] w-[6px]">
          ...
          <p className="font-['Delight',sans-serif] leading-[22px] not-italic overflow-hidden relative shrink-0 text-[14px] text-[var(--text-n9)] text-ellipsis tracking-[0.14px]">{title}</p>
          {/* 状态指示灯 */}
      ...
      <div className="content-stretch flex gap-[16px] items-center justify-end relative shrink-0">
        <div className="content-stretch flex gap-[2px] items-center overflow-clip relative shrink-0">
          <p className="font-['Delight',sans-serif] leading-[20px] not-italic relative shrink-0 text-[12px] text-[var(--text-n9)] tracking-[0.12px]">V1</p>
        </div>
        {/* 收藏 */}
          ...
          <div className="bg-white h-[36px] relative rounded-[6px] shrink-0 w-full">
            <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex gap-[6px] items-center justify-center px-[12px] py-[6px] relative size-full">
                ...
                <p className="font-['Delight',sans-serif] font-medium leading-[20px] not-italic overflow-hidden relative shrink-0 text-[12px] text-[var(--text-n9)] text-ellipsis tracking-[0.12px]">Chat</p>
              </div>
            </div>
            <div aria-hidden="true" className="absolute border-[0.5px] border-[var(--line-l3)] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[var(--shadow-xs)]" />
          </div>
        </div>
      </div>
    </div>
