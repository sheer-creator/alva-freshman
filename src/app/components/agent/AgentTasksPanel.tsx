...
function TaskRow({ task, onClick }: { task: AgentTask; onClick?: () => void }) {
  ...
  /* 卡片 — Figma 7911:134316:border 0.5 l2 / 圆角 8 / gap 12;统一 p-20;点击进二级页 */
  return (
    <div
      className="group flex w-full cursor-pointer items-start gap-[12px] rounded-[8px] p-[20px] transition-shadow hover:shadow-xs"
