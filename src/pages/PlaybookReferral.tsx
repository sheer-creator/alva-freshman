...
function AlvaMark({ size = 26 }: { size?: number }) {
  return (
...
export default function PlaybookReferral({ onNavigate }: { onNavigate: (page: Page) => void }) {
  ...
  return (
    <div className="relative h-screen overflow-hidden font-['Delight',sans-serif]">
      ...
      <div className="absolute inset-0 z-50 flex items-center justify-center">
        <div
          className="w-[400px] rounded-[20px] overflow-hidden"
          style={{ background: '#fff', boxShadow: '0 1px 2px rgba(0,0,0,0.04), 0 16px 48px rgba(0,0,0,0.12)' }}
        >
          {/* 顶栏 */}
