...
export const CREATOR_AVATARS: Record<string, string> = {
  ...
  'Mira Chen': `${import.meta.env.BASE_URL}avatars/mira-chen.png`,
  'Vega Zhou': `${import.meta.env.BASE_URL}avatars/vega-zhou.png`,
  Robert: `${import.meta.env.BASE_URL}avatars/robert.png`,
  Rosy: `${import.meta.env.BASE_URL}avatars/rosy.png`,
  Alvatothemoon: `${import.meta.env.BASE_URL}avatars/alvatothemoon.png`,
  'BTC Ultimate AI Trader': `${import.meta.env.BASE_URL}avatars/playbook-btc-ultimate.png`,
  'ETH Swing Setup': `${import.meta.env.BASE_URL}avatars/playbook-eth-swing.png`,
