...
function BarNavBarTier({ onNavigateToHome, onNavigateToExplore, onNavigateToDashboard, onNavigateToWorkspace, onNavigateToTest, onOpenSearch, isUserInfoOpen, onUserMouseEnter, onUserMouseLeave }: {
