  ...
  const option = {
    tooltip: {
      ...
      formatter: function(params: any) {
        ...
        const p = params[0];
        return `<div style="font-family:'Delight',-apple-system,BlinkMacSystemFont,sans-serif;font-size:12px;font-weight:400;color:rgba(0,0,0,0.9)">${p.name}: ${p.value}</div>`;
      }
    },
    grid: {
      left: 100,
