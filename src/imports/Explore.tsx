...
function BarNavBarTier({ onNavigateToHome, onNavigateToLibrary, onNavigateToDashboard, onNavigateToWorkspace, onNavigateToTest, onOpenSearch, isUserInfoOpen, onUserMouseEnter, onUserMouseLeave }: {
