...
(function () {
  'use strict';
  var DEMOS = [{"title":"Alva Ask 轻量化方案 Brief","route":"/demo/alva-ask-fast-path-brief.html"},{"title":"Alva Channel Product Spec","route":"/demo/alva-channel-workspace.html"},{"title":"KOL Digest Channel","route":"/demo/alva-homepage-planb-kol-channel.html"},{"title":"Alva — Homepage Plan B (Agent as Homepage)","route":"/demo/alva-homepage-planb.html"},{"title":"Alva — Homepage Plan C (Single-Channel MVP · Onboarding-first)","route":"/demo/alva-homepage-planc.html"},{"title":"Alva — Mobile v4 (push 归因 · Room-Digest · 只读 Automations · 未连接态)","route":"/demo/alva-mobile/Alva Mobile v4.html"},{"title":"Alva — Mobile v5 (单频道 MVP · 渠道化 Onboarding · Skill 全局共享)","route":"/demo/alva-mobile/Alva Mobile v5.html"},{"title":"Playbook Template Creator Voice Surfaces","route":"/demo/demo-playbook-template-creator-voice.html"},{"title":"Alva 付费用户旅程 - logangallina77","route":"/demo/logangallina77-paid-user-journey-cn.html"}];
