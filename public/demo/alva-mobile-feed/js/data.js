...
/* ========== Feeds ========== */
export const FEEDS = {
  nvda_events:  { id: 'nvda_events',  name: 'NVDA Important Events',   owner: 'Alva',   access: 'public',  cadence: 'Continuous', entities: ['NVDA'], sources: ['nvda_ir', 'sec', 'dylan', 'x_analysts', 'mkt_data'], last_run: '18m ago', runs: 214, promise: 'Only the changes that matter for NVIDIA — filings, guidance, supply chain, competitor read-through.' },
  earnings:     { id: 'earnings',     name: 'Earnings Intelligence',   owner: 'Alva',   access: 'public',  cadence: 'Earnings season', entities: ['NVDA', 'META', 'AMD', 'MU'], sources: ['sec', 'mkt_data', 'x_analysts'], last_run: '2h ago', runs: 96, promise: 'What each print actually changed: surprise, guidance, narrative shifts, after-hours reaction.' },
  ai_watch:     { id: 'ai_watch',     name: 'AI Infrastructure Watch', owner: 'Alva',   access: 'public',  cadence: 'Daily',   entities: ['AI_INFRA', 'NVDA', 'AMD', 'MU'], sources: ['semianalysis', 'dylan', 'localllama', 'nvda_ir', 'mkt_data'], last_run: '41m ago', runs: 380, promise: 'Capex, compute supply and the money flowing into AI infrastructure.' },
  doom_macro:   { id: 'doom_macro',   name: 'Doomberg Macro',          owner: 'Doomberg', access: 'premium', cadence: 'Weekly', entities: ['NUCLEAR'], sources: ['doomberg'], last_run: '3d ago', runs: 52, promise: 'Energy-first macro calls, before they become consensus.' },
  tg_alpha:     { id: 'tg_alpha',     name: 'My Telegram Alpha',       owner: 'You',    access: 'private', cadence: 'Continuous', entities: ['BTC'], sources: ['alpha_group'], last_run: '12m ago', runs: 1041, promise: 'Your private groups, distilled. Only you can see this.' },
  brief:        { id: 'brief',        name: 'Morning Market Brief',    owner: 'Alva',   access: 'public',  cadence: 'Daily 7:00', entities: [], sources: ['mkt_data', 'sec', 'x_analysts'], last_run: '7:00 today', runs: 365, promise: 'The five minutes that set up your trading day.' },
  congress:     { id: 'congress',     name: 'Congressional Trades',    owner: 'Alva',   access: 'public',  cadence: 'On disclosure', entities: [], sources: ['capitol'], last_run: '1d ago', runs: 128, promise: 'Every disclosed trade on the Hill, linked to what members oversee.' },
};
