/* ========== app.js — router & boot ========== */
import { store, closeSheet } from './state.js?v=local-mudzui';
import { renderRoute, TAB_ROUTES } from './screens.js?v=local-mudzui';
import { ACTIONS } from './actions.js?v=local-mudzui';
