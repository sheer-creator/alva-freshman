/* ========== app.js — router & boot ========== */
import { store, closeSheet } from './state.js?v=local-mu983m';
import { renderRoute, TAB_ROUTES } from './screens.js?v=local-mu983m';
import { ACTIONS } from './actions.js?v=local-mu983m';
