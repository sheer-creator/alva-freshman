/* ========== app.js — router & boot ========== */
import { store, closeSheet } from './state.js?v=local-mueycn';
import { renderRoute, TAB_ROUTES } from './screens.js?v=local-mueycn';
import { ACTIONS } from './actions.js?v=local-mueycn';
